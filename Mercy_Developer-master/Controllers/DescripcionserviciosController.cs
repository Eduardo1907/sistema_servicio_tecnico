...
namespace Mercy_Developer.Controllers
{
    public class DescripcionserviciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ServicioId,Nombre")] Descripcionservicio descripcionservicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ServicioId,Nombre")] Descripcionservicio descripcionservicio)
        {
